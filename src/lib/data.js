...
export async function getAccountData() {
  ...
  const [wallets, trades, transactions, notifications, opportunities] = await Promise.all([
  ...
  return { wallets: wallets.data || [], trades: trades.data || [], transactions: transactions.data || [], notifications: notifications.data || [], opportunities: opportunities.data || [], error: wallets.error || trades.error || transactions.error || notifications.error || opportunities.error };
}